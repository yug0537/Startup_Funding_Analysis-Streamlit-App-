...
df=pd.read_csv('Final_Startup-2.csv')
...
def load_overall_Analysis():
    ...
    fig, ax = plt.subplots()  # All graphs in ax,subplot is making pie
...
def load_investor(investor):
    ...
    with col1:
     ...
     st.dataframe(big_invest,width=250,height=270)
    ...
    with col1:
      ...
      fig, ax = plt.subplots(figsize=(20,10))  # All graphs in ax,subplot is making pie
